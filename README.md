...
The main course uses the built-in `mtcars` dataset. The `data` folder contains
the Islander CSV dataset for the advanced final challenge.
...
This is the second part of a two-part curriculum designed to introduce R and ggplot2. If you are unfamiliar with the basic syntax, data types, and the tidyverse in R, then you should first check out Part One at: <https://github.com/ELIXIREstonia/2026-06-16-R-basic>.
